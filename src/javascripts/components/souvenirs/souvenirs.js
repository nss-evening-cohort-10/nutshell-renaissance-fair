...
const buildSouvenirs = () => {
  souvenirData.getSouvenirData()
    .then((souvenirs) => {
      ...
      domString += `<div class="d-flex justify-content-center"><button type="button" class="btn btn-primary addNewSouvenirButton" data-toggle="modal" data-target="#addSouvenirModal">
      Add New Souvenir
    </button></div>`;
